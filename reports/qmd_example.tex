...
Note: this report is adapted from Timbers (Timbers 2020).
...
: Standard deviation of historical (1906-1972) horse populations for
each Canadian province. \{\#tbl-horses-sd\}
...
Additionally, note that in Table Table~\ref{tbl-horses-sd} we consider
the sample standard deviation of the number of horses during the same
time span as Figure Figure~\ref{fig-horse-populations}.
...
\{python\} largest\_sd, which had the largest spread of values in terms
